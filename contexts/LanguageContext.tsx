...
const translations: Record<Language, Translations> = {
    vi: {
        ...
        // Market Intelligence
        market: {
            title: 'Thông Số Thị Trường',
            intelligence: 'Phân Tích Thị Trường',
            waitingData: 'Đang chờ dữ liệu',
            waitingDataDesc: 'Thông số thị trường sẽ hiển thị khi có dữ liệu',
            sentimentIndex: 'Chỉ Số Tâm Lý',
            volatilityFlow: 'Biến Động',
            riskFactors: 'Yếu Tố Rủi Ro',
            protocolAdvice: 'Khuyến Nghị',
            dangerLevel: 'Mức Nguy Hiểm',
            safe: 'An toàn',
            caution: 'Cẩn thận',
            danger: 'Nguy hiểm',
        ...
        chat: {
            ...
            placeholderActive: 'Đang kết nối...',
            systemOffline: 'Hệ thống ngoại tuyến',
            sendFailed: 'Gửi thất bại',
            thinking: 'đang suy nghĩ...',
            motivateMe: 'Động viên tôi',
            feelingAnxious: 'Tôi đang lo lắng',
            analyzeProcess: 'Phân tích quy trình',
            coreStable: 'Hệ thống ổn định',
        },

        // Widgets & Common Labels
        widgets: {
            processScore: 'Điểm Quy Trình',
            trendHint: 'Xu Hướng Gợi Ý',
            survivalDays: 'Ngày Sống Sót',
            disciplineScore: 'Điểm Kỷ Luật',
            tradeCount: 'Số Lệnh',
            winRate: 'Tỷ Lệ Thắng',
    ...
    en: {
        ...
        market: {
            ...
            waitingDataDesc: 'Market data will display when available',
            sentimentIndex: 'Sentiment Index',
            volatilityFlow: 'Volatility',
        ...
        chat: {
            ...
            placeholderActive: 'Connecting...',
            systemOffline: 'System Offline',
            sendFailed: 'Send failed',
            thinking: 'thinking...',
            motivateMe: 'Motivate me',
            feelingAnxious: 'I am feeling anxious',
            analyzeProcess: 'Analyze process',
            coreStable: 'System stable',
        },
